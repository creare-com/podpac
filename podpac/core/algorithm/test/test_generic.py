...
class TestArithmetic(object):
    ...
    def test_evaluate(self):
        with podpac.settings:
            ...
            a = sine_node.evaluate(coords)
            b = sine_node.evaluate(coords)
...
class TestGeneric(object):
    ...
    def test_evaluate(self):
        with podpac.settings:
            ...
            a = node.evaluate(coords)
            b = node.evaluate(coords)
...
class TestMask(object):
    def test_mask_defaults(self):
        ...
        sine_node = Arange()
        a = sine_node.evaluate(coords).copy()
...
class TestCombine(object):
    ...
    def test_eval(self):
        ...
        np.testing.assert_array_equal(output.sel(output="a"), Arange().evaluate(coords))
        np.testing.assert_array_equal(output.sel(output="b"), Arange().evaluate(coords))
        np.testing.assert_array_equal(output.sel(output="c"), Arange().evaluate(coords))
