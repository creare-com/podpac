...
class TestReprojection(object):
    ...
    def test_reprojection_Coordinates(self):
        ...
        o1 = reproject.evaluate(self.source_coords)
        o2 = self.source_coarse.evaluate(self.source_coords)

        assert_array_equal(o1.data, o2.data)

        node = podpac.Node.from_json(reproject.json)
        o3 = node.evaluate(self.source_coords)
    ...
    def test_reprojection_source_coords(self):
        ...
        o1 = reproject.evaluate(self.coarse_coords)
        o2 = self.source_coarse.evaluate(self.coarse_coords)

        assert_array_equal(o1.data, o2.data)

        node = podpac.Node.from_json(reproject.json)
        o3 = node.evaluate(self.coarse_coords)
        assert_array_equal(o1.data, o3.data)
    ...
    def test_reprojection_Coordinates_crs(self):
        ...
        o2 = self.source_coarse2.evaluate(self.source_coords.transform("EPSG:3857"))
        ...
        o1 = reproject.evaluate(self.source_coords.transform("EPSG:3857"))
        o2 = self.source_coarse2.evaluate(self.source_coords.transform("EPSG:3857"))
        assert_almost_equal(o1.data, o2.data, decimal=13)
