...
class TestTimedeltaUtils(object):
    ...
    def test_get_timedelta_unit(object):
        td64 = np.timedelta64
    ...
    def test_make_timedelta_string(object):
        td64 = np.timedelta64
...
class TestCoordUtils(object):
    def test_make_coord_value(self):
        # numbers
    ...
    def test_make_coord_delta(self):
        # numbers
